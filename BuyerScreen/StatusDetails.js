  ...
  return (
    ...
    >
      ...
      <View style={{ width: '90%', alignSelf: 'center' }}>
        ...
        <TouchableOpacity style={styles.dashboardButton2} onPress={() =>Update('pending')}>
        ...
        <TouchableOpacity style={styles.dashboardButton} onPress={() => Update('UnDone')}>
          <Text style={styles.dashboardButtonText}>Un Done</Text>
        </TouchableOpacity>
      </View>
